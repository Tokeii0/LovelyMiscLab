...
pushDesc("image_to_bits", "图像处理", "图像转 01", IMGT, iin(), [p("text", "0/1 文本", "text"), p("width", "宽", "number", false), p("height", "高", "number", false)], [num("threshold", "阈值", 0, 255, 1, 128), tog("otsu", "自动阈值(Otsu)", false), tog("invert", "取反(亮=1)", false)]);
